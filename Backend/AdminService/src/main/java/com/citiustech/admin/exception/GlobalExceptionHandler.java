...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ResponseObject> handleExpenseNotFoundException(EmployeeNotFoundException exception,
			WebRequest request) {
	...
	public ResponseEntity<ResponseObject> handleItemExistException(EmployeeAlreadyExistException exception,
			WebRequest request) {

		ResponseObject ResponseObject = new ResponseObject();
		ResponseObject.setHttpStatusCode(HttpStatus.CONFLICT.value());
		ResponseObject.setMessage(exception.getMessage());
		ResponseObject.setLocalDateTime(LocalDateTime.now());

		return new ResponseEntity<ResponseObject>(ResponseObject, HttpStatus.CONFLICT);
